...
public class EncryptUtil {
     ...
     * @return
     */
    public static String getHash(String source, String hashType) throws NoSuchAlgorithmException {
        // 用来将字节转换成 16 进制表示的字符
...
//        System.out.println(getHash("小鹏", "MD5"));
//        System.out.println(getHash("小鹏", "SHA") + "\n");

        System.out.println(getHash2("小鹏", "MD5"));
        System.out.println(getHash2("小鹏", "SHA") + "\n");

//        System.out.println(getHash3("小鹏", "MD5"));
//        System.out.println(getHash3("小鹏", "SHA") + "\n");
    }
}
